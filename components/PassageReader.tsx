...
interface PassageReaderProps {
  title: string;
  body: string;
  /** Featured passage id, or null when reading a user-saved library passage. */
...
export function PassageReader({ title, body, sourcePassageId }: PassageReaderProps) {
  ...
  }, [popover, sourcePassageId, captureMutation]);
            ...
            return (
              <Text
                ...
                onPress={() => {
                  ...
                  const sentence = findSentenceAt(body, offset);
